...
fn main() {
    println!("Exibindo o somatório dos elementos situados nas posições de linha e coluna ímpares na diagonal principal da matriz A.");
    ...
    println!("A={:?}", a);
    println!(
        "O somatório dos elementos situados nas posições de linha e coluna ímpares na diagonal principal da matriz A é : {} ",
        somatorio
    );
